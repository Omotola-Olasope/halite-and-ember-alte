  ...
  return (
    <div className="page-container">
      ...
      <section className="page-hero">
        <h1 className="display-large">{mockData.ukBranch.title}</h1>
        <p className="body-large hero-description">
          {mockData.ukBranch.description}
        </p>
      </section>
      ...
      <section className="highlights-section">
        ...
        <div className="highlights-grid">
          {mockData.ukBranch.highlights.map((highlight, idx) => (
      ...
      <section className="team-section">
        ...
        <div className="team-grid">
          {mockData.ukBranch.team.map((member, idx) => (
        ...
        <div className="contact-info-grid">
          <div className="contact-info-item">
            ...
            <div>
              ...
              <p className="body-medium">{mockData.ukBranch.address}</p>
            </div>
          </div>
          <div className="contact-info-item">
            <Phone size={24} />
            <div>
              ...
              <p className="body-medium">{mockData.ukBranch.phone}</p>
            </div>
          </div>
          <div className="contact-info-item">
            <Mail size={24} />
            <div>
              ...
              <p className="body-medium">{mockData.ukBranch.email}</p>
            </div>
          </div>
        </div>
      </section>
